                                        ...
                                        <tbody>
                                            <c:forEach items="${list}" var="o">
                                                <tr>
                                                    <th scope="row">
                                                        <div class="p-2">
                                                            <img src="./AllBook/${o.pic}" alt="" width="70" class="img-fluid rounded shadow-sm">
                                                    ...
                                                    <td class="align-middle">
                                                        <a href="./subbookcart.html?id=${o.id}"><button class="btnSub">-</button></a> 
                                                        
                                                        <strong>${o.amount}</strong>
                                                        <a href="./addbookcart.html?id=${o.id}"><button class="btnAdd">+</button></a>
                                                    </td>
                                                    <td class="align-middle"><a href="./deletebookcart.html?id=${o.id}" class="text-dark">
                        ...
                        <div class="row py-5 p-4 bg-white rounded shadow-sm">
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    ...
                                    </ul><a href="./buy.html?totalmoney=${money}&&email=${email}" class="btn btn-dark rounded-pill py-2 btn-block">Mua hàng</a>
                                </div>
                            </div>
                        </div>
