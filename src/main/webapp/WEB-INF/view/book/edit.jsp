    ...
    <body>
        ...
        <section>
            <div  >
                ...
                <form id="editBook" action="./save.html" method="POST">
                    ...
                    <div>
                        ...
                        <textarea type="text" name="content" rows="10" cols ="90">${b.content}</textarea>                    </div>
                    <div>
                        <label ><b>Phân loại: </b></label>
                        <input type="text" name="classify" value="${b.classify}" required>
